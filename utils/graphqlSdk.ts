...
export type InsertEncryptedTestPhraseMutation = (
  { __typename?: 'mutation_root' }
  & { insert_password_test: Maybe<(
    { __typename?: 'password_test_mutation_response' }
    & Pick<Password_Test_Mutation_Response, 'affected_rows'>
  )> }
);
...
export type EncryptedTestPhrasePhraseQueryQuery = (
  { __typename?: 'query_root' }
  & { password_test: Array<(
    { __typename?: 'password_test' }
    & Pick<Password_Test, 'encrypted_test_phrase'>
  )> }
);
...
export function getSdk(client: GraphQLClient) {
  return {
    ...
    InsertEncryptedTestPhrase(variables: InsertEncryptedTestPhraseMutationVariables): Promise<InsertEncryptedTestPhraseMutation> {
      return client.request<InsertEncryptedTestPhraseMutation>(print(InsertEncryptedTestPhraseDocument), variables);
    },
    ...
    EncryptedTestPhrasePhraseQuery(variables?: EncryptedTestPhrasePhraseQueryQueryVariables): Promise<EncryptedTestPhrasePhraseQueryQuery> {
      return client.request<EncryptedTestPhrasePhraseQueryQuery>(print(EncryptedTestPhrasePhraseQueryDocument), variables);
    }
  };
}
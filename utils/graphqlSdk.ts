...
export type InsertGridMutationMutation = {__typename?: 'mutation_root'} & {
  insert_grid: Maybe<
    {__typename?: 'grid_mutation_response'} & Pick<Grid_Mutation_Response, 'affected_rows'>
  >
  insert_lab_result: Maybe<
    {__typename?: 'lab_result_mutation_response'} & Pick<
      Lab_Result_Mutation_Response,
      'affected_rows'
    >
  >
}
...
export type InsertApplicationMutationMutation = {__typename?: 'mutation_root'} & {
  insert_application: Maybe<
    {__typename?: 'application_mutation_response'} & Pick<
...
export type UpdateLabResultPositiveMutationMutation = {__typename?: 'mutation_root'} & {
...
export type UpdateLabResultSampleCodeMutationMutation = {__typename?: 'mutation_root'} & {
  update_lab_result: Maybe<
    {__typename?: 'lab_result_mutation_response'} & Pick<
      Lab_Result_Mutation_Response,
      'affected_rows'
...
export type UpdateApplicationMutationMutation = {__typename?: 'mutation_root'} & {
...
export type UpdateGridMutationMutation = {__typename?: 'mutation_root'} & {
  update_grid: Maybe<
    {__typename?: 'grid_mutation_response'} & {
      returning: Array<
...
export type DeleteGridMutationMutation = {__typename?: 'mutation_root'} & {
  delete_grid: Maybe<
    {__typename?: 'grid_mutation_response'} & Pick<Grid_Mutation_Response, 'affected_rows'>
  >
}
...
export type DeleteLabResultMutationMutation = {__typename?: 'mutation_root'} & {
...
export type InsertEncryptedTestPhraseMutationVariables = {
  test_phrase: Scalars['String']
}

export type InsertEncryptedTestPhraseMutation = {__typename?: 'mutation_root'} & {
  insert_password_test: Maybe<
    {__typename?: 'password_test_mutation_response'} & Pick<
      Password_Test_Mutation_Response,
      'affected_rows'
    >
  >
}
...
export type GridQueryQuery = {__typename?: 'query_root'} & {
  grid_by_pk: Maybe<{__typename?: 'grid'} & Pick<Grid, 'id' | 'test_finished_date'>>
}

export type ApplicationsQueryQueryVariables = {}

export type ApplicationsQueryQuery = {__typename?: 'query_root'} & {
  application: Array<
...
export type ApplicationsBySampleCodeQeryQuery = {__typename?: 'query_root'} & {
  application: Array<{__typename?: 'application'} & Pick<Application, 'id'>>
}
...
export type ApplicationQueryQuery = {__typename?: 'query_root'} & {
  application: Array<
    {__typename?: 'application'} & Pick<
      Application,
      | 'id'
...
export type GridWithLabResultsQueryQuery = {__typename?: 'query_root'} & {
  grid_by_pk: Maybe<
    {__typename?: 'grid'} & Pick<
      Grid,
      | 'created_at'
...
export type GridsQueryQuery = {__typename?: 'query_root'} & {
  grid: Array<
    {__typename?: 'grid'} & Pick<
      Grid,
      | 'id'
...
export type LabResultQueryQuery = {__typename?: 'query_root'} & {
  lab_result: Array<
    {__typename?: 'lab_result'} & Pick<
      Lab_Result,
      'id' | 'referenced_in_grid_id' | 'sample_code' | 'updated_at' | 'positive'
    >
  >
}

export type EncryptedTestPhrasePhraseQueryQueryVariables = {}

export type EncryptedTestPhrasePhraseQueryQuery = {__typename?: 'query_root'} & {
  password_test: Array<
    {__typename?: 'password_test'} & Pick<Password_Test, 'encrypted_test_phrase'>
  >
}
...
`
export const InsertEncryptedTestPhraseDocument = gql`
  mutation InsertEncryptedTestPhrase($test_phrase: String!) {
    insert_password_test(objects: {encrypted_test_phrase: $test_phrase}) {
      affected_rows
    }
  }
`
...
`
export const EncryptedTestPhrasePhraseQueryDocument = gql`
  query EncryptedTestPhrasePhraseQuery {
    password_test {
      encrypted_test_phrase
    }
  }
`
export function getSdk(client: GraphQLClient) {
  return {
    InsertGridMutation(
      variables: InsertGridMutationMutationVariables,
    ): Promise<InsertGridMutationMutation> {
      return client.request<InsertGridMutationMutation>(
        print(InsertGridMutationDocument),
        variables,
      )
    },
    InsertApplicationMutation(
      variables: InsertApplicationMutationMutationVariables,
    ): Promise<InsertApplicationMutationMutation> {
      return client.request<InsertApplicationMutationMutation>(
        print(InsertApplicationMutationDocument),
        variables,
      )
    },
    UpdateLabResultPositiveMutation(
      variables: UpdateLabResultPositiveMutationMutationVariables,
    ): Promise<UpdateLabResultPositiveMutationMutation> {
      return client.request<UpdateLabResultPositiveMutationMutation>(
        print(UpdateLabResultPositiveMutationDocument),
        variables,
      )
    },
    UpdateLabResultSampleCodeMutation(
      variables: UpdateLabResultSampleCodeMutationMutationVariables,
    ): Promise<UpdateLabResultSampleCodeMutationMutation> {
      return client.request<UpdateLabResultSampleCodeMutationMutation>(
        print(UpdateLabResultSampleCodeMutationDocument),
        variables,
      )
    },
    UpdateApplicationMutation(
      variables: UpdateApplicationMutationMutationVariables,
    ): Promise<UpdateApplicationMutationMutation> {
      return client.request<UpdateApplicationMutationMutation>(
        print(UpdateApplicationMutationDocument),
        variables,
      )
    },
    UpdateGridMutation(
      variables: UpdateGridMutationMutationVariables,
    ): Promise<UpdateGridMutationMutation> {
      return client.request<UpdateGridMutationMutation>(
        print(UpdateGridMutationDocument),
        variables,
      )
    },
    DeleteGridMutation(
      variables: DeleteGridMutationMutationVariables,
    ): Promise<DeleteGridMutationMutation> {
      return client.request<DeleteGridMutationMutation>(
        print(DeleteGridMutationDocument),
        variables,
      )
    },
    DeleteLabResultMutation(
      variables: DeleteLabResultMutationMutationVariables,
    ): Promise<DeleteLabResultMutationMutation> {
      return client.request<DeleteLabResultMutationMutation>(
        print(DeleteLabResultMutationDocument),
        variables,
      )
    },
    InsertEncryptedTestPhrase(
      variables: InsertEncryptedTestPhraseMutationVariables,
    ): Promise<InsertEncryptedTestPhraseMutation> {
      return client.request<InsertEncryptedTestPhraseMutation>(
        print(InsertEncryptedTestPhraseDocument),
        variables,
      )
    },
    ...
    ApplicationsQuery(
      variables?: ApplicationsQueryQueryVariables,
    ): Promise<ApplicationsQueryQuery> {
      return client.request<ApplicationsQueryQuery>(print(ApplicationsQueryDocument), variables)
    },
    ApplicationsBySampleCodeQery(
      variables: ApplicationsBySampleCodeQeryQueryVariables,
    ): Promise<ApplicationsBySampleCodeQeryQuery> {
      return client.request<ApplicationsBySampleCodeQeryQuery>(
        print(ApplicationsBySampleCodeQeryDocument),
        variables,
      )
    },
    ...
    GridWithLabResultsQuery(
      variables: GridWithLabResultsQueryQueryVariables,
    ): Promise<GridWithLabResultsQueryQuery> {
      return client.request<GridWithLabResultsQueryQuery>(
        print(GridWithLabResultsQueryDocument),
        variables,
      )
    },
    ...
    EncryptedTestPhrasePhraseQuery(
      variables?: EncryptedTestPhrasePhraseQueryQueryVariables,
    ): Promise<EncryptedTestPhrasePhraseQueryQuery> {
      return client.request<EncryptedTestPhrasePhraseQueryQuery>(
        print(EncryptedTestPhrasePhraseQueryDocument),
        variables,
      )
    },
  }

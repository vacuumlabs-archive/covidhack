...
export type PasswordPhraseQueryQueryVariables = {};


export type PasswordPhraseQueryQuery = (
  { __typename?: 'query_root' }
  & { password_test: Array<(
    { __typename?: 'password_test' }
    & Pick<Password_Test, 'test_phrase'>
  )> }
);
...
export const LabResultQueryDocument = gql`
  ...
  lab_result(order_by: {updated_at: asc}) {
    ...
    `;
export const PasswordPhraseQueryDocument = gql`
    query PasswordPhraseQuery {
  password_test {
    test_phrase
  }
}
...
export function getSdk(client: GraphQLClient) {
  return {
    ...
    PasswordPhraseQuery(variables?: PasswordPhraseQueryQueryVariables): Promise<PasswordPhraseQueryQuery> {
      return client.request<PasswordPhraseQueryQuery>(print(PasswordPhraseQueryDocument), variables);
    }
  };
}